...
$starttext = [["start" => "Du Findest eine Notiz auf dem Boden, in der Notiz steht das sich irgendwo in der Stadt ein Schatz befindet. Also Startest du die Suche"],
    ["start" => 'Ein verdeckt gekleiderter Mann rempelt dich an und lässt Notiz fallen, auf der Notiz steht:"Der Schatz ist in der Stadt". Da du nichts zu tun hast beginnst du die Suche nach dem Schatz'],
    ["start" => "Dein Vater  erzählt dir von einem Schatz den er in seiner Kindheit gesucht hat, er soll irgendwo in der Stadt sein. Also versuchst du es selber mal und suchst nach dem Schatz"]];
